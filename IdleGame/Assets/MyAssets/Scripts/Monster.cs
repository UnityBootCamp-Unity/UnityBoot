...
public class Monster : Unit
{
    ...
    private void Update()
    {
        ...
        //3. MoveTowrads(start, end, speed); start부터 end 지점까지 speed 수치만큼 이동합니다.
        //4. Time.deltaTime : 이전 프레임이 완료되기까지 걸린 시간
        //                    (컴퓨터의 성능이 느릴수록 값이 커짐)
        //                    일반적으로 약 1초
        //                    업데이트에서 작업을 하는데 있어서의 보정 값 역할
        //5. transform.LookAt(Vector3.zero) : 특정 방향을 바라보게 설정해주는 기능

        //방향 벡터 : 기본적으로 제공해주는 Vector 값
        //Vector3.right == new Vector3(1,0, 0); // 오른쪽 방향을 나타냅니다.
        //Vector3.left == new Vector3(-1,0, 0); // 왼쪽 방향을 나타냅니다.
        //Vector3.up == new Vector3(0,1, 0); // 위쪽 방향을 나타냅니다.
        //Vector3.down == new Vector3(0,-1, 0); // 아래쪽 방향을 나타냅니다.
        //Vector3.forward == new Vector3(0, 0, 1); // 앞쪽 방향을 나타냅니다.
        //Vector3.back == new Vector3(0, 0, -1); // 뒤쪽 방향을 나타냅니다.
        //Vector3.zero == new Vecotr3(0, 0, 0); // 0,0,0 좌표를 나타냅니다.
        //Vector3.one == new Vecotr3(1, 1, 1); // 1,1,1 좌표를 나타냅니다.
        #endregion
    }
